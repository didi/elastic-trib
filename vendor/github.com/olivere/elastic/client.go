...
// CatIndicesService cat indices
func (c *Client) CatIndicesService() *CatIndicesService {
	return NewCatIndicesService(c)
}

// CatMasterService cat master
func (c *Client) CatMasterService() *CatMasterService {
	return NewCatMasterService(c)
}

// CatNodesService cat nodes
func (c *Client) CatNodesService() *CatNodesService {
	return NewCatNodesService(c)
}

// CatShardsService cat shards
func (c *Client) CatShardsService() *CatShardsService {
	return NewCatShardsService(c)
}

// CatAllocService cat allocation
func (c *Client) CatAllocService() *CatAllocService {
	return NewCatAllocService(c)
}

// CatRecoveryService cat recovery
func (c *Client) CatRecoveryService() *CatRecoveryService {
	return NewCatRecoveryService(c)
}

// CatAliasService cat aliases
func (c *Client) CatAliasService() *CatAliasService {
	return NewCatAliasService(c)
}

func (c *Client) CatNodeAttrsService() *CatNodeAttrsService {
	return NewCatNodeAttrsService(c)
}
...
// ClusterPendingTasksService retrieves cluster pending tasks.
func (c *Client) ClusterPendingTasksService() *ClusterPendingTasksService {
	return NewClusterPendingTasksService(c)
}
...
func (c *Client) ClusterGetSettings() *ClusterGetSettingsService {
	return NewClusterGetSettingsService(c)
}

func (c *Client) ClusterPutSettings() *ClusterPutSettingsService {
	return NewClusterPutSettingsService(c)
}
